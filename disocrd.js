...
async function playercountgetter(region) {
  ...
  try {
    let playercount = await fetch(`https://api.lanyard.rest/v1/users/1169111190824308768`);
...
async function playercountstart() {
  //username
  let euusernamecountnumber = await usernamecountgetter("username");
  //NA
  ...
  currentlyplaying.innerHTML =
    '<div data-v-78c6e76c="" data-v-0ae66549="">status:</div>';
